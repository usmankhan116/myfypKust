            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container"><br>
                     <h1 class="fashion_taital">Medicine</h1>
                     <div class="main" style="">
                        ...
                        <div class="input-group">
                           ...
                           </div> <input type="search"  id="filter"  class="form-control" placeholder="Search medicine here">
                        </div>
                     </div>
                        ...
                        <div class="row">
                           ...
                           <div class=" col-lg-4 col-sm-4 item ">
                              ...
                              <div class="box_main" >
                                 ...
                                 <h4 class="shirt_text">{{$item->name}} , {{$item->formula}}</h4>
                              
                                 <p class="price_text">Price  <span style="color: #262626;"> 
                                 
                                    @if($item->Discount>0)
                                    <strike>  {{$item->price}}    </strike> 
                                    @php  $totalPrice= $item->price -($item->price * $item->Discount /100);
                                 ...
                                 <div class="tshirt_img" style="margin-top: -5px"><img  class="Myimg"  src="{{"../assets/images/".$item->image}}">
                                 <br><br>     <br>
                                    <div class="btn_main" style="margin-left:-30%" >
                        
                                       @if(session("verification")==true)
                                       <div class="buy_bt" ><a href="/ProductAddTocart/{{$item->id}}">Add to cart</a></div>
                                       @else 
                                       <div class="buy_bt">  <a href="/">Login</a>   </div>
